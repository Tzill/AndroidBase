...
//        методе жизненного цикла onCreate (...) .
    ...
    protected void initLayout(View view, Bundle savedInstanceState) {
        ...
        if (Data.isHumidityChecked()) ((TextView)getBaseActivity().findViewById(R.id.tv_humidity)).setText("30%");
        if (Data.isPressureChecked()) ((TextView)getBaseActivity().findViewById(R.id.tv_pressure)).setText("752mmHg");
